...
const Internship = () => {
  ...
  const handleSaveToDatabase = async () => {
    const requiredFields = ['candidateName', 'fatherName', 'email', 'joiningDate', 'leavingDate', 'issueDate'];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-6">
        <button
          ...
          disabled={isGenerating || isSaving || !formData.candidateName || !formData.fatherName || !formData.email || !formData.joiningDate || !formData.leavingDate}
