    ...
    const checkAuth = async () => {
      try {
        ...
        if (userError || !userData) {
          showToast("User not found or inactive", 'error');
          navigate("/login", { replace: true });
          return;
        }
        ...
        <form onSubmit={handleChangePassword} style={componentStyles.form}>
          ...
          <div style={componentStyles.securityNotice}>
            ...
            <ul style={componentStyles.noticeList}>
              <li>After changing your password, you'll be logged out automatically</li>
              <li>All other active sessions will be terminated for security</li>
