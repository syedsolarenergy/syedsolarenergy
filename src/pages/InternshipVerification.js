        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Internship Certificate Verification</h1>
                <p className="text-amber-100">Syed Solar Energy - Certificate Verification System</p>
              </div>
            </div>
            <button
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-800">{formatDate(verificationData.dob)}</p>
                          </div>
                        </div>
                        <div className="flex items-center">
                    ...
                    {verificationData.university_name && (
                      <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-100 shadow-sm">
                        ...
                        <div className="flex items-center">
                          <BookOpen className="mr-3 text-amber-600" size={18} />
                          <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-800">{formatDate(verificationData.joining_date)}</p>
                          </div>
                        </div>
                        <div className="flex items-center">
                          <Calendar className="mr-3 text-amber-600" size={18} />
                          <div>
                            ...
                            <p className="font-semibold text-gray-800">{formatDate(verificationData.leaving_date)}</p>
                          </div>
                        </div>
                        <div className="flex items-center">
