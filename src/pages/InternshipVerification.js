  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center w-full sm:w-auto">
              <div className="w-10 sm:w-12 lg:w-14 h-10 sm:h-12 lg:h-14 bg-gradient-to-br from-orange-600 to-amber-600 rounded-lg sm:rounded-xl flex items-center justify-center text-white font-bold text-sm sm:text-base lg:text-lg mr-3 sm:mr-4 shadow-lg shadow-orange-500/50 flex-shrink-0">
                <div className="transform rotate-3">SSE</div>
              </div>
              <div className="min-w-0 flex-1">
                <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white leading-tight">Internship Certificate Verification</h1>
                <p className="text-xs sm:text-sm text-amber-100 mt-1 truncate sm:whitespace-normal">Syed Solar Energy - Certificate Verification System</p>
              </div>
            </div>
            <button
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        {/* Search Section */}
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 border border-orange-200 transform transition-transform hover:translate-y-[-2px] sm:hover:translate-y-[-5px]">
          <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800 mb-4 sm:mb-6 flex items-center">
            <div className="p-1.5 sm:p-2 bg-gradient-to-r from-orange-500 to-amber-500 rounded-lg mr-2 sm:mr-3 shadow-md flex-shrink-0">
              <Search className="text-white" size={18} />
            </div>
            <span className="min-w-0">Verify Internship Certificate</span>
          </h2>
          ...
          <div className="flex flex-col gap-3 sm:gap-4">
            <input
              ...
              className="w-full px-4 sm:px-5 py-3 sm:py-4 border border-orange-200 rounded-lg sm:rounded-xl focus:ring-2 sm:focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 shadow-sm text-sm sm:text-base"
            />
            <button
              onClick={handleSearch}
              disabled={loading || !searchId.trim()}
              className="w-full sm:w-auto bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold transition-all duration-300 flex items-center justify-center shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transform hover:-translate-y-1 text-sm sm:text-base"
            >
          ...
          <div className="mt-4 sm:mt-6 flex items-center text-xs sm:text-sm text-amber-600">
        ...
        {/* Loading State */}
        {loading && (
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8 text-center border border-orange-100">
            <div className="animate-spin w-10 sm:w-12 lg:w-14 h-10 sm:h-12 lg:h-14 border-3 sm:border-4 border-orange-500 border-t-transparent rounded-full mx-auto mb-3 sm:mb-4"></div>
        ...
        {!loading && verificationStatus && (
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl p-4 sm:p-6 lg:p-8 border border-orange-200">
              ...
              <div>
                <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-orange-100 shadow-sm">
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4 flex items-center">
                        <div className="p-1.5 sm:p-2 bg-orange-500 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="flex items-start">
                          <User className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-start">
                          <Calendar className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                            <p className="text-xs sm:text-sm text-gray-500">Date of Birth</p>
                            <p className="font-semibold text-gray-800 text-sm sm:text-base">{formatDate(verificationData.dob)}</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <Mail className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                        ...
                        {verificationData.contact && (
                          <div className="flex items-start">
                            <Phone className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                            <div className="min-w-0 flex-1">
                        ...
                        {verificationData.address && (
                          <div className="flex items-start">
                            <MapPin className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                            <div className="min-w-0 flex-1">
                    ...
                    {verificationData.university_name && (
                      <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-amber-100 shadow-sm">
                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4 flex items-center">
                          <div className="p-1.5 sm:p-2 bg-amber-500 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                            <BookOpen className="text-white" size={16} />
                          </div>
                          <span className="min-w-0">University Information</span>
                        </h3>
                        <div className="flex items-start">
                          <BookOpen className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                            <p className="text-xs sm:text-sm text-gray-500">University Name</p>
                            <p className="font-semibold text-gray-800 text-sm sm:text-base break-words">{verificationData.university_name}</p>
                          </div>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-orange-100 shadow-sm">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="flex items-start">
                          <Shield className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                            <p className="text-xs sm:text-sm text-gray-500">Certificate ID</p>
                            <p className="font-semibold text-gray-800 text-sm sm:text-base font-mono break-all">{verificationData.certificate_id}</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <Calendar className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="font-semibold text-gray-800 text-sm sm:text-base">{formatDate(verificationData.joining_date)}</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <Calendar className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                            <p className="text-xs sm:text-sm text-gray-500">Leaving Date</p>
                            <p className="font-semibold text-gray-800 text-sm sm:text-base">{formatDate(verificationData.leaving_date)}</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <Clock className="mr-3 text-amber-600 mt-1 flex-shrink-0" size={16} />
                          <div className="min-w-0 flex-1">
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-amber-100 shadow-sm">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="flex items-center">
                          <div className="bg-white p-2 rounded-lg mr-3 border border-amber-200 flex-shrink-0">
                            <img 
                ...
                {/* Company Info */}
                <div className="mt-6 sm:mt-8 bg-gradient-to-r from-orange-600 to-amber-600 text-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
        ...
        {!loading && !verificationStatus && !certificateId && (
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8 text-center border border-orange-100">
            <div className="relative inline-block mb-4 sm:mb-6">
              <Search className="mx-auto text-orange-400 mb-3 sm:mb-4 relative z-10" size={50} />
              <div className="absolute -inset-3 sm:-inset-4 bg-orange-100 rounded-full blur-lg opacity-50 z-0"></div>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-lg sm:rounded-xl p-4 sm:p-5 text-left max-w-md mx-auto">
              <h4 className="font-semibold text-orange-800 mb-3 flex items-center text-sm sm:text-base">
                <Shield className="mr-2 flex-shrink-0" size={16} />
                Certificate ID Format:
              </h4>
              <p className="text-orange-700 text-sm font-mono">SSE-IC-YYYYMMDD-XXXX</p>
