...
const handlePanelBrandChange = (e) => {
  ...
  async function handleGenerateQuotation(e) {
    ...
    setTimeout(async () => {
      try {
        // Generate enhanced PDF with higher quality
        ...
        // Professional PDF with max 2 pages
        ...
        while (remaining > 0) {
          ...
          pdf.text(
            `Page ${pageNum} of ${pagesNeeded > 2 ? 2 : pagesNeeded} | Generated by Syed Solar Energy`,
            pageW / 2,
            pageH - M / 2,
            { align: "center" }
          );
...
JazakAllah! 🤝`
  ...
  // Enhanced form UI
    ...
    <main style={{ 
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "20px" }}>
        ...
        <div style={{
          ...
          <h1 style={{ margin: "0 0 10px 0", fontSize: isSmallScreen ? "24px" : "32px", fontWeight: 900 }}>
   ...
   // Enhanced Styles with responsive classes
const sectionBox = { 
